...
public class BoardController {
    ...
    public boolean deleteBoard(@PathVariable Long id, @RequestBody BoardDeleteRequestDto boardDeleteRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails){
        return boardService.deleteBoardByPassword(id, boardDeleteRequestDto, userDetails.getUser());
    }
